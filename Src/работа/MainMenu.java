...
public class MainMenu {
    ...
    public static void main(Holding args) {
        ...
        while (true) {
            ...
            if (command == 1) {
                ...
                holding.addCompany(new Company("Toyota", employee, 700000, "Alisa"));
                holding.addCompany(new Company("Mercedes", employee, 500000, "Elena"));
                holding.addCompany(new Company("Nissan", employee, 400000, "Stanislav"));
                System.out.println();
            } else if (command == 5) {
